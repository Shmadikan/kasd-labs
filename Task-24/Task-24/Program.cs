...
namespace Task_24
{
    ...
    public class MyTreeSet<K>:IEnumerable where K : IComparable
    {
        ...
        public TreeSubSet HeadSet(K upperbound, bool incl) {
            return new TreeSubSet(this, upperbound, incl);
        }


        public TreeSubSet SubSet(K lowerBound, K upperbound, bool highincl, bool lowincl)
        {
            return new TreeSubSet(this, upperbound, lowerBound, highincl, lowincl);
        }


        public TreeSubSet TailSet(K lowerbound, bool incl) {
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            MyTreeSet<int> secondtree = tree.SubSet(2, 10, true, true);
